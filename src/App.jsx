...
function App() {
  ...
  return (
    <div className='bg-white w-screen h-screen flex flex-col items-center justify-start'>
      <div className={`translationHistory h-screen w-[500px] bg-black text-white rounded-2xl p-4 absolute all duration-300 ease-in-out ${isOpen?'left-[0px]':'left-[-500px]'}`}>
      ...
      <Title />
      <div className="App bg-black flex justify-center items-center w-[75vw] h-[60vh] rounded-2xl">
        <div className="mainArea flex flex-col h-full w-full justify-around">
          <div className="translateArea flex gap-30 justify-center w-full">
            <div className="from bg-[#495057] focus:bg-[#6c757d] rounded-3xl p-4 w-[40%]">
            ...
            <div className="to bg-[#495057] rounded-3xl p-4 w-[40%]">
          ...
          <div className="functionality flex justify-around">
            <div className="from bg-[#495057] rounded-2xl">
            ...
            <div className="to bg-[#495057] rounded-2xl">
          ...
          <div className='flex justify-center'>
            <button id="translateBtn" className='bg-white w-[300px] text-black p-3 rounded-3xl font-bold disabled:bg-[#6c757d] select-none' disabled={fromText.length < 1 || fromLang.length < 2 || toLang.length < 2} onClick={handleTranslate}>
              TRANSLATE
            </button>
          </div>
        </div>
